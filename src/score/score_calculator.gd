...
func _ready():
	...
	print("Score Calculator ready with %d patterns" % patterns.size())
...
func calculate_score_with_state(slot_grid_result: Array, game_state) -> Dictionary:
	...
	var highlight_positions = []  # NEW: Track positions to highlight
...
# ============================================================================
# FREE FLOWING LINE MATCHING (ORIGINAL LOGIC)
# ============================================================================
