extends Node
#var sound_lever: AudioStream = preload()
#var sound_reel_stop: AudioStream = preload()
#var sound_payout: AudioStream = preload()
...
#var sound_victory: AudioStream = preload()
#var sound_lose: AudioStream = preload()
